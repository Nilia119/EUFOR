...
class EUFOR_Backpacks_Tortilia_Medic : EUFOR_Backpacks_Tortilia_Base_Medic {
    author = "$STR_EUFOR_Backpacks_Author";
    scope = 2;
    displayName = "$STR_EUFOR_Backpacks_Tortilia_Medic";
    picture = "EUFOR_Backpacks\Medic\ui\EUFOR_Backpacks_Tortilia_Medic_Icon.paa";
    hiddenSelectionsTextures[]={"EUFOR_Backpacks\Medic\EUFOR_Backpacks_Tortilia_Medic_co.paa"};
    maximumLoad = 900;
    mass = 40;
};
...
class EUFOR_Backpacks_Compact_Medic : EUFOR_Backpacks_Compact_Base_Medic {
    author = "$STR_EUFOR_Backpacks_Author";
    scope = 2;
...
class EUFOR_Backpacks_Kitbag_Medic : EUFOR_Backpacks_Kitbag_Base_Medic {
    author = "$STR_EUFOR_Backpacks_Author";
    scope = 2;
