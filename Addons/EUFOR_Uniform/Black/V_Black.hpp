/* ------- Normal ------- */
class EUFOR_Soldat_Black: EUFOR_Soldat
{
...
class EUFOR_Soldat_Black1: EUFOR_Soldat
{
  author = "$STR_EUFOR_Uniform_Author";
  scope = 1;
  scopeCurator = 0;
...
/* ------- Ärmel hoch ------- */
class EUFOR_Soldat_Black_Sleeves: EUFOR_Soldat_Sleeves
{
  author = "$STR_EUFOR_Uniform_Author";
  scope = 1;
  scopeCurator = 0;
...
class EUFOR_Soldat_Black1_Sleeves: EUFOR_Soldat_Sleeves
{
  author = "$STR_EUFOR_Uniform_Author";
  scope = 1;
  scopeCurator = 0;
...
/* ------- T-Shirt ------- */
class EUFOR_Soldat_Black_Shirt: EUFOR_Soldat_Shirt
{
  author = "$STR_EUFOR_Uniform_Author";
  scope = 1;
  scopeCurator = 0;
...
/* ------- Normal Tarn------- */
class EUFOR_Soldat_Tarn_Black: EUFOR_Soldat
{
  author = "$STR_EUFOR_Uniform_Author";
  scope = 1;
  scopeCurator = 0;
...
/* ------- Tarn Ärmel hoch ------- */
class EUFOR_Soldat_Tarn_Black_Sleeves: EUFOR_Soldat_Sleeves
{
  author = "$STR_EUFOR_Uniform_Author";
  scope = 1;
  scopeCurator = 0;
...
/* ------- Tarn T-Shirt ------- */
class EUFOR_Soldat_Tarn_Black_Shirt: EUFOR_Soldat_Shirt
{
  author = "$STR_EUFOR_Uniform_Author";
  scope = 1;
  scopeCurator = 0;
